...
export function UserAvatar({ src, initial, className }) {
  ...
  return (
    <span className={cn("grid size-8 shrink-0 place-items-center overflow-hidden rounded-full bg-brand font-semibold text-white select-none", className)}>
...
export function ProviderTile({ provider, className }) {
  ...
  return (
    <span
      className={cn("grid size-8 shrink-0 place-items-center rounded-lg font-display text-sm font-bold shadow-[inset_0_0_0_1px_rgb(0_0_0/0.06)]", className)}
